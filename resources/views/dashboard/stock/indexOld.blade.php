        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                ...
                <button type="button" class="btn btn-default btn-sm float-right ml-1 mr-1"
                        onclick="activarBoton('content_btn_ajustes', 'header_btn_ajustes')" id="header_btn_ajustes"
                    {{--wire:click="verAjustes" @if($view == "ajustes" || !comprobarPermisos('ajustes.index')) disabled @endif--}}>
                    <i class="fas fa-list"></i> Ajustes
                </button>
                <button type="button" class="btn btn-default btn-sm float-right ml-1 mr-1 disabled"
                        onclick="activarBoton('content_btn_existencias', 'header_btn_existencias')"
                        id="header_btn_existencias"
                ...
                <button type="button" wire:click="show" class="btn btn-default btn-sm float-right ml-1 mr-1"
                        onclick="activarBoton('content_btn_actualizar', 'header_btn_actualizar')"
