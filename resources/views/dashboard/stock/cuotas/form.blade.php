        ...
        <form wire:submit="save">
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <select class="custom-select" wire:model="mes">
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="date" class="form-control" wire:model="fecha" placeholder="Fecha Inicio">
                    @error('fecha')
                    <span class="col-sm-12 text-sm text-bold text-danger">
                        <i class="icon fas fa-exclamation-triangle"></i>
                        {{ $message }}
            ...
            <div class="form-group mt-3">
                ...
                <button type="submit" class="btn btn-block @if($cuotas_id) btn-primary @else btn-success @endif "
                @if(!comprobarPermisos() || ($cuotas_id && !comprobarPermisos())) disabled @endif >
                    <i class="fas fa-save"></i> Guardar @if($cuotas_id) Cambios @endif
                </button>
            </div>
