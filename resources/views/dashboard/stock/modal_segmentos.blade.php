    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <div class="row col-md-12">
                    ...
                    <div class="col-md-5 justify-content-end">
                        <form wire:submit.prevent="buscarSegmentos">
                            <div class="input-group close">
                                <input type="search" class="form-control" placeholder="Buscar" wire:model.defer="keywordSegmento" required>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-4">
                        @include('dashboard.stock.card_form_segmentos')
                    </div>
                    <div class="col-md-8">
                        @include('dashboard.stock.card_table_segmentos')
                    </div>
                </div>
